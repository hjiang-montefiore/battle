...
static func _ARCHETYPE_TYPES() -> Dictionary:
	var A := SimTypes.ArmorType
	return {
		"none": [A.NONE, A.NONE, A.NONE, A.NONE, A.NONE, A.NONE, A.NONE],
		"soft": [A.RHA, A.RHA, A.RHA, A.RHA, A.RHA, A.RHA, A.RHA],
		"light": [A.RHA, A.RHA, A.RHA, A.SPACED, A.ERA_LIGHT, A.ERA_LIGHT,
			A.MODULAR_ERA],
		"medium": [A.CAST, A.SPACED, A.NERA, A.COMPOSITE, A.COMPOSITE_HEAVY,
			A.ERA_HEAVY, A.MODULAR_ERA],
		...
		"heavy": [A.CAST, A.SPACED, A.COMPOSITE, A.COMPOSITE_HEAVY, A.ERA_HEAVY,
			A.MODULAR_ERA, A.MODULAR_ERA],
		"building": [A.RHA, A.RHA, A.RHA, A.RHA, A.RHA, A.RHA, A.RHA],
		"bunker": [A.RHA, A.RHA, A.RHA, A.RHA, A.RHA, A.RHA, A.RHA],
	}
...
static func _ensure() -> void:
	if not _roles.is_empty():
		return
	var D := SimPlayerSetup.Domain
	var C := SimTypes.Category
	var M := SimTypes.DamageModel
	var S := D.STRUCTURES
	var G := D.GROUND
	var I := D.INFANTRY
	var A := D.AIR
	...
	"hq": {"name": "Headquarters", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 1500.0, "build_seconds": 40.0,
		"upkeep": 0.0, "damage_model": M.STRUCTURE, "hp": 900.0,
	...
	"power_plant": {"name": "Power Plant", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 700.0, "build_seconds": 25.0,
		"damage_model": M.STRUCTURE, "hp": 500.0, "armor": "building",
		"power_supply": 100.0, "build_radius": 140.0,
		"rcs": 300.0, "visual": 600.0, "mount": 18.0, "ir": 6.0},
	"oil_derrick": {"name": "Oil Derrick", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 900.0, "build_seconds": 20.0,
		"damage_model": M.STRUCTURE, "hp": 350.0, "armor": "building",
		"extraction": 240.0, "build_radius": 90.0,
		"rcs": 220.0, "visual": 400.0, "mount": 20.0},
	"refinery": {"name": "Refinery", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 1400.0, "build_seconds": 35.0,
		"damage_model": M.STRUCTURE, "hp": 600.0, "armor": "building",
	...
	"light_factory": {"name": "Light Vehicle Factory", "domain": S,
		"category": C.GROUND, "is_structure": true, "cost": 900.0,
		"build_seconds": 28.0, "damage_model": M.STRUCTURE, "hp": 500.0,
	...
	"heavy_factory": {"name": "Heavy Vehicle Factory", "domain": S,
		"category": C.GROUND, "is_structure": true, "cost": 1600.0,
		"build_seconds": 40.0, "damage_model": M.STRUCTURE, "hp": 700.0,
		"armor": "building", "power_draw": 45.0, "build_radius": 160.0,
		"requires": ["power_plant"], "footprint": 20.0,
		"rcs": 380.0, "visual": 780.0, "mount": 12.0},
	"airbase": {"name": "Airbase", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 2000.0, "build_seconds": 50.0,
		"damage_model": M.STRUCTURE, "hp": 800.0, "armor": "building",
	...
	"hardened_shelter": {"name": "Hardened Aircraft Shelter", "domain": S,
		"category": C.GROUND, "is_structure": true, "first_epoch": 2,
		"cost": 800.0, "build_seconds": 25.0, "damage_model": M.STRUCTURE,
		"hp": 900.0, "armor": "bunker", "requires": ["airbase"],
		"build_radius": 60.0, "rcs": 120.0, "visual": 300.0, "mount": 6.0},
	"helipad": {"name": "Helipad", "domain": S, "category": C.GROUND,
		"is_structure": true, "first_epoch": 2, "cost": 500.0,
		"build_seconds": 18.0, "damage_model": M.STRUCTURE, "hp": 350.0,
	...
	"naval_yard": {"name": "Naval Yard", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 1800.0, "build_seconds": 45.0,
		"damage_model": M.STRUCTURE, "hp": 700.0, "armor": "building",
	...
	"fixed_radar": {"name": "Fixed Radar Station", "domain": S,
		"category": C.GROUND, "is_structure": true, "cost": 1100.0,
		"build_seconds": 30.0, "damage_model": M.STRUCTURE, "hp": 400.0,
		"armor": "building", "power_draw": 55.0, "sensor": "fixed_search",
		"mount": 28.0, "build_radius": 80.0,
		"rcs": 240.0, "visual": 300.0},
	"fixed_sam": {"name": "Fixed SAM Site", "domain": S, "category": C.GROUND,
		"is_structure": true, "first_epoch": 2, "cost": 1200.0,
		"build_seconds": 30.0, "damage_model": M.STRUCTURE, "hp": 500.0,
	...
	"coastal_battery": {"name": "Coastal Battery", "domain": S,
		"category": C.GROUND, "is_structure": true, "first_epoch": 2,
		"cost": 1000.0, "build_seconds": 28.0, "damage_model": M.STRUCTURE,
		"hp": 600.0, "armor": "bunker", "build_radius": 60.0,
		"rcs": 120.0, "visual": 260.0, "mount": 8.0},
	"ew_station": {"name": "EW Station", "domain": S, "category": C.GROUND,
		"is_structure": true, "first_epoch": 2, "cost": 1300.0,
		"build_seconds": 32.0, "damage_model": M.STRUCTURE, "hp": 400.0,
	...
	"research_facility": {"name": "Research Facility", "domain": S,
		"category": C.GROUND, "is_structure": true, "cost": 1500.0,
		"build_seconds": 45.0, "damage_model": M.STRUCTURE, "hp": 550.0,
	...
	"repair_depot": {"name": "Repair Depot", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 900.0, "build_seconds": 25.0,
		"damage_model": M.STRUCTURE, "hp": 450.0, "armor": "building",
	...
	"bunker": {"name": "Bunker", "domain": S, "category": C.GROUND,
		"is_structure": true, "cost": 400.0, "build_seconds": 15.0,
		"damage_model": M.STRUCTURE, "hp": 800.0, "armor": "bunker",
		"build_radius": 0.0, "footprint": 10.0,
		"rcs": 40.0, "visual": 90.0, "mount": 3.0},

	# ══ GROUND — manoeuvre ══════════════════════════════════════════════════
	"mbt": {"name": "Main Battle Tank", "domain": G, "category": C.GROUND,
	...
	"ballistic_launcher": {"name": "Ballistic Missile Launcher", "domain": G,
		"category": C.GROUND, "first_epoch": 2, "built_by": "heavy_factory",
		"cost": 1500.0, "build_seconds": 35.0, "upkeep": 20.0,
		"speed_kmh": 45.0, "fuel": 900.0, "burn_idle": 3.0,
		"burn_cruise": 16.0, "burn_combat": 30.0, "damage_model": M.UNARMORED,
	...
	"coastal_asm": {"name": "Coastal Anti-Ship Battery", "domain": G,
		...
		"burn_cruise": 13.0, "burn_combat": 26.0, "damage_model": M.UNARMORED,
	...
	"spaag": {"name": "SPAAG", "domain": G, "category": C.GROUND,
		"built_by": "heavy_factory", "cost": 560.0, "build_seconds": 15.0,
		"upkeep": 8.0, "speed_kmh": 65.0, "fuel": 700.0, "burn_idle": 3.0,
		"burn_cruise": 13.0, "burn_combat": 30.0, "damage_model": M.ARMORED,
		"hp": 75.0, "armor": "light", "armor_class": 1, "sensor": "eo",
		"rcs": 13.0, "ir": 1.2, "visual": 15.0, "mount": 3.0},
	"shorad_sam": {"name": "SHORAD SAM", "domain": G, "category": C.GROUND,
		...
		"burn_combat": 30.0, "damage_model": M.ARMORED, "hp": 75.0,
		"armor": "light", "armor_class": 1, "sensor": "eo",
	...
	"fuel_truck": {"name": "Fuel Truck", "domain": G, "category": C.GROUND,
		"built_by": "light_factory", "cost": 250.0, "build_seconds": 8.0,
		"upkeep": 3.0, "speed_kmh": 70.0, "fuel": 3200.0, "burn_idle": 1.0,
		"burn_cruise": 6.0, "burn_combat": 12.0, "damage_model": M.UNARMORED,
	...
	# ══ AIR — combat ════════════════════════════════════════════════════════
	"interceptor": {"name": "Interceptor", "domain": A, "category": C.AIR,
	...
	"air_superiority": {"name": "Air Superiority Fighter", "domain": A,
		...
		"burn_combat": 1050.0, "damage_model": M.AIRFRAME, "hp": 100.0,
		"armor": "none", "sensor": "fighter_radar", "rcs": 6.0, "ir": 7.0,
		"visual": 34.0, "mount": 0.0},
	"multirole": {"name": "Multirole Fighter", "domain": A, "category": C.AIR,
	...
	"strike_aircraft": {"name": "Strike Aircraft", "domain": A,
		...
		"damage_model": M.AIRFRAME, "hp": 110.0, "armor": "none",
		"sensor": "fighter_radar", "rcs": 14.0, "ir": 5.0, "visual": 36.0,
		"mount": 0.0},
	"cas": {"name": "Close Air Support", "domain": A, "category": C.AIR,
		...
		"damage_model": M.AIRFRAME, "hp": 170.0, "armor": "none",
		"sensor": "eo", "rcs": 12.0, "ir": 4.0, "visual": 30.0, "mount": 0.0},
	"bomber": {"name": "Bomber", "domain": A, "category": C.AIR,
		...
		"damage_model": M.AIRFRAME, "hp": 260.0, "armor": "none",
		"sensor": "esm", "rcs": 100.0, "ir": 9.0, "visual": 120.0,
		"mount": 0.0},
	"sead": {"name": "SEAD Aircraft", "domain": A, "category": C.AIR,
	...
	"stealth_strike": {"name": "Stealth Strike Aircraft", "domain": A,
		"category": C.AIR, "first_epoch": 4, "built_by": "airbase",
		...
		"burn_combat": 900.0, "damage_model": M.AIRFRAME, "hp": 100.0,
	...
	"aewc": {"name": "AEW&C Aircraft", "domain": A, "category": C.AIR,
		...
		"damage_model": M.AIRFRAME, "hp": 160.0, "armor": "none",
		"sensor": "aew", "rcs": 90.0, "ir": 7.0, "visual": 110.0,
		"mount": 0.0, "requires": ["research_facility"]},
	"aew_helicopter": {"name": "AEW Helicopter", "domain": A, "category": C.AIR,
	...
	"electronic_attack": {"name": "Electronic Attack Aircraft", "domain": A,
		...
		"burn_combat": 700.0, "damage_model": M.AIRFRAME, "hp": 110.0,
		"armor": "none", "sensor": "esm", "rcs": 18.0, "ir": 5.0,
		"visual": 40.0, "mount": 0.0},
	"tanker": {"name": "Aerial Tanker", "domain": A, "category": C.AIR,
		...
		"damage_model": M.AIRFRAME, "hp": 180.0, "armor": "none",
		"supply_radius": 4000.0, "supply_rate": 1800.0,
		"rcs": 110.0, "ir": 8.0, "visual": 130.0, "mount": 0.0},
	"isr_aircraft": {"name": "ISR Aircraft", "domain": A, "category": C.AIR,
	...
	"attack_helicopter": {"name": "Attack Helicopter", "domain": A,
		"category": C.AIR, "first_epoch": 3, "built_by": "helipad",
	...
	"transport_helicopter": {"name": "Transport Helicopter", "domain": A,
		...
		"burn_combat": 150.0, "damage_model": M.AIRFRAME, "hp": 110.0,
		"armor": "none", "rcs": 14.0, "ir": 3.5, "visual": 32.0,
		"mount": 0.0},
	"asw_helicopter": {"name": "ASW Helicopter", "domain": A, "category": C.AIR,
		...
		"damage_model": M.AIRFRAME, "hp": 100.0, "armor": "none",
		"sensor": "dipping", "rcs": 12.0, "ir": 3.2, "visual": 28.0,
		"mount": 0.0},
	"recon_uav": {"name": "Reconnaissance UAV", "domain": A, "category": C.AIR,
		...
		"damage_model": M.AIRFRAME, "hp": 35.0, "armor": "none",
		"sensor": "recon", "rcs": 0.4, "ir": 0.5, "visual": 8.0,
		"mount": 0.0},
	"armed_uav": {"name": "Armed UAV", "domain": A, "category": C.AIR,
		...
		"damage_model": M.AIRFRAME, "hp": 40.0, "armor": "none",
		"sensor": "recon", "rcs": 0.5, "ir": 0.6, "visual": 9.0,
		"mount": 0.0},
	"loitering_munition": {"name": "Loitering Munition", "domain": A,
		"category": C.AIR, "first_epoch": 7, "built_by": "light_factory",
		...
		"burn_combat": 3.0, "damage_model": M.AIRFRAME, "hp": 18.0,
	...
	"air_defence_destroyer": {"name": "Air-Defence Destroyer", "domain": N,
		"category": C.SURFACE, "first_epoch": 4, "built_by": "naval_yard",
		...
		"burn_combat": 2600.0, "damage_model": M.HULL, "hp": 900.0,
		"armor": "soft", "sensor": "naval", "rcs": 3000.0, "ir": 12.0,
		"acoustic": 130.0, "visual": 2400.0, "mount": 30.0},
	"asw_frigate": {"name": "ASW Frigate", "domain": N, "category": C.SURFACE,
		...
		"damage_model": M.HULL, "hp": 620.0, "armor": "soft",
		"sensor": "asw_ship", "rcs": 2000.0, "ir": 10.0,
		"acoustic": 122.0, "visual": 1700.0, "mount": 24.0},
	"cruiser": {"name": "Cruiser", "domain": N, "category": C.SURFACE,
	...
	"corvette": {"name": "Corvette / Fast Attack Craft", "domain": N,
		...
		"damage_model": M.HULL, "hp": 300.0, "armor": "soft",
		"sensor": "asw_ship", "rcs": 600.0, "ir": 6.0,
		"acoustic": 118.0, "visual": 600.0, "mount": 14.0},
	"missile_boat": {"name": "Missile Boat", "domain": N, "category": C.SURFACE,
	...
	"ssk": {"name": "Diesel-Electric Submarine", "domain": N,
		...
		"damage_model": M.HULL, "hp": 380.0, "armor": "soft",
	...
	"ssn": {"name": "Nuclear Attack Submarine", "domain": N,
		"category": C.SUBSURFACE, "first_epoch": 2, "built_by": "naval_yard",
		...
		"damage_model": M.HULL, "hp": 480.0, "armor": "soft",
	...
	"aip_sub": {"name": "AIP Submarine", "domain": N, "category": C.SUBSURFACE,
		...
		"damage_model": M.HULL, "hp": 420.0, "armor": "soft",
	...
	"midget_sub": {"name": "Midget Submarine", "domain": N,
		"category": C.SUBSURFACE, "built_by": "naval_yard", "cost": 700.0,
		...
		"damage_model": M.HULL, "hp": 120.0, "armor": "soft",
	...
	"ssbn": {"name": "Ballistic Missile Submarine", "domain": N,
		"category": C.SUBSURFACE, "first_epoch": 3, "built_by": "naval_yard",
	...
	"carrier": {"name": "Aircraft Carrier", "domain": N, "category": C.SURFACE,
		...
		"nuclear": true, "nuclear_from_epoch": 3,
		"damage_model": M.HULL, "hp": 2000.0, "armor": "soft",
	...
	"amphib": {"name": "Amphibious Assault Ship", "domain": N,
		"category": C.SURFACE, "first_epoch": 2, "built_by": "naval_yard",
		...
		"burn_combat": 2200.0, "damage_model": M.HULL, "hp": 900.0,
	...
	"landing_craft": {"name": "Landing Craft", "domain": N,
		"category": C.SURFACE, "built_by": "naval_yard", "cost": 400.0,
	...
	# fleet's RANGE."
	"oiler": {"name": "Fleet Oiler", "domain": N, "category": C.SURFACE,
		...
		"damage_model": M.HULL, "hp": 700.0, "armor": "soft",
	...
	"mine_warfare": {"name": "Mine Warfare Vessel", "domain": N,
		"category": C.SURFACE, "built_by": "naval_yard", "cost": 900.0,
